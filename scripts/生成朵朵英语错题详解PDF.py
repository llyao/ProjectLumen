...
原始文档 = 项目目录 / "朵朵" / "6年级" / "记录" / "英语" / "错题" / "2026-09-14-英语错题逐题详解.md"
输出文件 = 项目目录 / "朵朵" / "6年级" / "记录" / "英语" / "错题" / "2026-09-14-英语错题逐题详解.pdf"
...
body { font-size: 10.2pt; line-height: 1.34; color: #243447; }
...
p { margin: 5px 0; }
table { table-layout: fixed; margin: 7px 0 12px; font-size: 9.2pt; }
...
def 主程序() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="朵朵英语错题详解-") as 临时目录文本:
        临时目录 = Path(临时目录文本)
        网页路径 = 临时目录 / "朵朵英语错题逐题详解.html"
